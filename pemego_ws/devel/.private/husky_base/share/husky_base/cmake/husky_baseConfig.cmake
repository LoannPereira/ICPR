...
if("TRUE" STREQUAL "TRUE")
  set(husky_base_SOURCE_PREFIX /home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/src/husky/husky_base)
  set(husky_base_DEVEL_PREFIX /home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/devel/.private/husky_base)
  ...
  set(husky_base_INSTALL_PREFIX /home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/install)
...
if(NOT "/home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/src/husky/husky_base/include;/usr/include " STREQUAL " ")
  set(husky_base_INCLUDE_DIRS "")
  set(_include_dirs "/home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/src/husky/husky_base/include;/usr/include")
  ...
  elseif(NOT "http://ros.org/wiki/husky_base " STREQUAL " ")
    set(_report "Check the website 'http://ros.org/wiki/husky_base' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'husky_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/src/husky/husky_base/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT husky_base_NUM_DUMMY_TARGETS)
      set(husky_base_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::husky_base::wrapped-linker-option${husky_base_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR husky_base_NUM_DUMMY_TARGETS "${husky_base_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::husky_base::wrapped-linker-option${husky_base_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND husky_base_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/devel/.private/husky_base/lib;/home/loann/Bureau/ICPR/TP4/ICPR/pemego_ws/devel/lib;/opt/ros/melodic/lib)
